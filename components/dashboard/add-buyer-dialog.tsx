...
export function AddBuyerDialog({ open, onOpenChange, onSuccess, initialData }: AddBuyerDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>{initialData ? "Edit Buyer" : "Add New Buyer"}</DialogTitle>
          <DialogDescription>
            {initialData 
              ? "Update the buyer's details below." 
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="submit" disabled={isLoading}>
                ...
                {initialData ? "Save Changes" : "Create Buyer"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
