...
interface InviteBidderDialogProps {
  open: boolean
...
export function InviteBidderDialog({ open, onOpenChange, onSuccess, eventId }: InviteBidderDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Invite Bidder to Event</DialogTitle>
          <DialogDescription>
            Send an invitation email to enroll a bidder in this auction event.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="email" placeholder="bidder@example.com" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
