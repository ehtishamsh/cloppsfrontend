...
const navItems = [
  ...
  { href: "/bidder/events", label: "Events", icon: Calendar },
  { href: "/bidder/bids", label: "My Bids", icon: Gavel },
  { href: "/bidder/statements", label: "Statements", icon: FileText },
  { href: "/bidder/profile", label: "Profile", icon: User },
]

export function MobileBidderSidebar() {
