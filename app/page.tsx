...
import { Calendar, Users, TrendingUp, Shield, ArrowRight, CheckCircle2, Zap, BarChart3 } from "lucide-react"
      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
              <Link href="/signup">
                <Button size="lg" className="h-14 px-8 text-base shadow-xl shadow-primary/20 hover:shadow-2xl hover:shadow-primary/30 transition-all">
                  Start Marketplace
            ...
            <div className="mt-20 rounded-xl border bg-background/50 backdrop-blur-sm shadow-2xl max-w-6xl mx-auto aspect-[16/9] flex items-center justify-center relative overflow-hidden group animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500 ring-1 ring-white/20">
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/5 to-transparent" />
              {/* Abstract UI representation */}
              <div className="w-full h-full p-4 md:p-8 grid grid-cols-12 gap-4 opacity-50 group-hover:opacity-80 transition-opacity duration-700">
                 <div className="col-span-3 bg-muted/50 rounded-lg h-full" />
                 <div className="col-span-9 grid grid-rows-6 gap-4">
                    <div className="row-span-1 bg-muted/50 rounded-lg w-full" />
                    <div className="row-span-2 grid grid-cols-3 gap-4">
                       <div className="bg-primary/10 rounded-lg" />
                       <div className="bg-muted/50 rounded-lg" />
                       <div className="bg-muted/50 rounded-lg" />
                    </div>
                    <div className="row-span-3 bg-muted/30 rounded-lg" />
                 </div>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                 <div className="bg-background/80 backdrop-blur-md border px-6 py-3 rounded-full shadow-lg flex items-center gap-3">
        ...
        <section className="py-12 border-y bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            <p className="text-sm font-medium text-muted-foreground mb-8">TRUSTED BY LEADING AUCTION HOUSES</p>
        ...
        <section id="features" className="py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-20 max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">Everything you need to scale</h2>
              <p className="text-xl text-muted-foreground">
                From inventory management to final payouts, Clopps handles the heavy lifting so you can focus on growing your business.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-muted/30 border-none shadow-none hover:bg-muted/50 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl mb-2">Event Management</CardTitle>
                  <p className="text-muted-foreground leading-relaxed">
                    Create and schedule auction events effortlessly. Manage lots, timelines, and locations in one unified interface.
                  </p>
                </CardHeader>
              </Card>
              ...
              <Card className="bg-muted/30 border-none shadow-none hover:bg-muted/50 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl mb-2">Financial Automation</CardTitle>
                  <p className="text-muted-foreground leading-relaxed">
                    Stop using spreadsheets. Automatically calculate commissions, taxes, and generate professional invoices instantly.
                  </p>
                </CardHeader>
              </Card>
            </div>
             ...
             <div className="grid md:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                   ...
                   <p className="text-lg text-muted-foreground">
                      Track your auction performance as it happens. Monitor bids, sales velocity, and revenue in real-time with our advanced analytics dashboard.
                   </p>
                   <ul className="space-y-4">
                      ...
                      <li className="flex items-center gap-3">
                         ...
                         <span className="font-medium">Automated post-sale reporting</span>
                      </li>
                   </ul>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              The complete operating system for modern auction marketplaces. Built for speed, reliability, and growth.
            </p>
          </div>
          <div>
