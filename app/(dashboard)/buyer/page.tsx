...
import { buyerService, type BuyerEnrollment, type BuyerPurchase, type BuyerStatement } from "@/services/bidder"
import { LoadingSkeleton } from "@/components/shared/loading"
import { toast } from "sonner"
import { EnrollmentsTable } from "@/components/dashboard/buyer/enrollments-table"
import { PurchasesTable } from "@/components/dashboard/buyer/purchases-table"
import { StatementsTable } from "@/components/dashboard/buyer/statements-table"

export default function BuyerDashboardPage() {
  const [isLoading, setIsLoading] = useState(true)
  const [enrollments, setEnrollments] = useState<BuyerEnrollment[]>([])
  ...
  const loadData = async () => {
    try {
      const [enrollmentData, purchaseData, statementData] = await Promise.all([
        buyerService.getEnrollments(),
        buyerService.getPurchases(),
        buyerService.getStatements(),
      ])
